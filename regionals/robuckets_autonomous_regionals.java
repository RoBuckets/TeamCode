...
public class robuckets_autonomous_regionals extends LinearOpMode {
    ...
    public void auto() {
        strafeDistance(1000); //4 ft
        driveDistance(1000); //1.7 ft
        ...
        if (color_sensor.blue() > 5 && color_sensor.blue() < 10) {
            driveDistance(1000); //0.25 ft
            stopDriving();
            driveDistance(1000); //-0.25 ft
            strafeDistance(1000); //0.25 ft
        }
        while (color_sensor.blue() > 5 && color_sensor.blue() < 10) {
            strafe(0.5);
        }
        ...
        if (color_sensor.blue() > 5 && color_sensor.blue() < 10) {
            driveDistance(1000); //0.25 ft
            stopDriving();
            driveDistance(1000); //-0.75 ft
        }
        turnDistance(1000); //0.75 ft
        autoLaunch(0.5, 0.75);
    }
